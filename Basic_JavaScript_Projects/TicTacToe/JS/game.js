...
function placeXOrO (squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        function checkWinConditions () {
            ...
            function arrayIncludes(squareA, squareB, squareC) {
                ...
                // If the variables we pass are included in our array true is 
        ...
        if (activePlayer === "O") {
            ...
            disableClick();
            // This function waits 1 second before the computer places image and enables click.
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            // If the random number evaluated returns true, the square hasn't been slected yet.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        // This is nessesary for the 6,4,2 win condition
        if (x1 <= x2 && y1 >= y2) {
        if (x < x2) { x += 10;} 
        if (y > y2) { y -= 10;}
        if (x >= x2 && y <= y2) {cancelAnimationFrame(animationLoop);}
        ...
        function clear() {
            ...
            animateLineDrawing();
            // This line waits 1 second. Then, clears canavs, resets game, and allows clicking again
